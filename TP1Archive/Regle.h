 ...
 * \class Regle
 *
 * \brief classe générique représentant des règles
 *
 *  La classe ajoute et gère des premisses et conclusions. L'implémentation
 *  des prémisses et conclusions se fait dans une liste simplement chainée.
 */
