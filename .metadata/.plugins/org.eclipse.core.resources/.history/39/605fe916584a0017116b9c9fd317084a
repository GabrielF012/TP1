...
int main()
{
	...
	SystemeExpert se1;		//Le système expert utilisé pour les tests de base.
	SystemeExpert se2;		//Le système expert utilisé principalement pour le chaînage avant.
	Regle re;				//Une règle.
	TypeFait fait;			//Un fait.
	ifstream EntreeFichier;		//Flux d'entrée
	ofstream SortieFichier;		//Flux de sortie
	ListeCirculaire<Regle> er;	//Une liste de règles pour le retour du chaînage avant.
